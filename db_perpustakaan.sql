...
--
-- Host: localhost:3306
-- Generation Time: Oct 08, 2025 at 01:16 PM
...
ALTER TABLE `buku_kategori`
  ADD KEY `id_bku` (`id_buku`),
  ADD KEY `idddd` (`id_kategori`);
...
--
ALTER TABLE `buku_kategori`
  ADD CONSTRAINT `id_bku` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `idddd` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
